...
4. با زدن کلید میانبر پیش‌فرض **`F8`** میتوانید پنجره فارسی‌نویس را باز کنید.

---

## ⚙️ تنظیمات ضروری

### ۱. تنظیم Launch Params (در لانچر ClientMod)
برای اینکه پنجره چت روی بازی اجرا شود قبل از اجرای کامل بازی کد زیر را در تنظیمات لانچر کلاینت‌مود بخش **`Launch Params`** وارد کنید: 
...
کنسول بازی را با کلید **`~`** باز کنید و دستور زیر را وارد کنید:

<div dir="ltr" align="left">
  <pre>snd_mute_losefocus 0</pre>
</div>
...
<div dir="ltr" align="left">
  <ul>
    <li><strong>Enter</strong> → ارسال به <strong>چت عمومی (All Chat)</strong></li>
    <li><strong>Shift + Enter</strong> → ارسال به <strong>چت تیمی (Team Chat)</strong></li>
  </ul>
</div>
