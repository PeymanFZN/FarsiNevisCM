...
4. با کلید میانبر پیش‌فرض **`F8`** پنجره فارسی‌نویس را میتوانید باز کنید.
...
### ۱. تنظیمات Launch Prams (در لانچر ClientMod)
برای اینکه پنجره چت روی بازی اجرا شود لازم است قبل از اجرای کامل بازی کد زیر را در تنظیمات لانچر کلاینت‌مود بخش **`Launch Prams`** وارد کنید: 
`-windowed -noborder`
